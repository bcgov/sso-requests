export const restoreTeamApiAccount = `
<h1>Your Pathfinder SSO CSS API Account has been restored.</h1>
<strong>Please note that the client secret has been reset so you will have to update your application config to use this API
  Account.</strong>
<p>
