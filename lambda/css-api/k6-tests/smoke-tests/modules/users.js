...
export const testUsers = (options) => {
  ...
  group('GET users associated to Azure IDIR', () => {
    {
      const url = BASE_URL + `/${__ENV.environment}/github/users`;
      const response = http.get(url, options);
    ...
    {
      const url = BASE_URL + `/${__ENV.environment}/github/users?param1=1&param2=2`;
      const response = http.get(url, options);
    ...
    {
      const url = BASE_URL + `/${__ENV.environment}/github/users?firstName=a&lastName=a&email=a&guid=a`;
      const response = http.get(url, options);
    ...
    {
      const url = BASE_URL + `/${__ENV.environment}/github/users?firstName=test`;
      const response = http.get(url, options);
    ...
    {
      const url = BASE_URL + `/${__ENV.environment}/github/users?lastName=user`;
      const response = http.get(url, options);
    ...
    {
      const url = BASE_URL + `/${__ENV.environment}/github/users?guid=312321dsadf3243dsf4543d`;
      const response = http.get(url, options);
