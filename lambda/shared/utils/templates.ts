...
export const getInvitationEmail = (teamId: number, invitationLink: string) => `<h1>Hello Pathfinder SSO friend,</h1>
  ...
  <p>
    Please follow this <a href="${API_URL}/teams/verify?token=${invitationLink}">link</a> to view your invitation in the dashboard. This link will expire in 2 business days.
  </p>
  <p>
