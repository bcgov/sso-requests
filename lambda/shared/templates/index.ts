...
const createVerifiedCredentialBottom = readTemplate('create-verified-credential-bottom');
...
Handlebars.registerPartial('createVerifiedCredentialBottom', createVerifiedCredentialBottom);
