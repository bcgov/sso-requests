...
const createVerifiableCredentialBottom = readTemplate('create-verified-credential-bottom');
...
Handlebars.registerPartial('createVerifiableCredentialBottom', createVerifiableCredentialBottom);
